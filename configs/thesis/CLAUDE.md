...
interfuser_visual_swap_m0_ft_gpu1_v1.json: M2 H1 M0-FT D7-minus-route39 GPU1 资源迁移配置，仅将 agent 与 CARLA 固定到同一 RTX 5090 GPU1。
interfuser_visual_swap_m0_v_gpu1_v1.json: M2 H1 M0-V D7-minus-route39 GPU1 配对配置，复用与 M0-FT 完全相同的同卡资源与评测参数。
