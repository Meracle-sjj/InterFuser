...
2026-08-04-m2-semantic-pedestrian-hazard-probe-v1.md: M2 行人碰撞威胁 train-only 扩充 probe，固化原 validation 和 8+8 个 route-group 专项 holdout 的 baseline/augmented 配对收益。
