...
2026-08-09-m2-m0-visual-swap-d7-gpu1-resource-migration.md: M2 M0-FT/M0-V D7-minus-route39 的 GPU1 同卡资源迁移记录，固化共享门禁、清理恢复、v2 路线作用域漂移、route0 超时和严格 18-task v3 重跑边界。
