...
class RouteProfileScoringTests(unittest.TestCase):
    def test_scores_nearby_elements_and_hard_negative_points(self):
        ...
        self.assertEqual(summary["dense_route_points"], 4)
        ...
        self.assertEqual(summary["relevant_stop_signs"], 1)
        self.assertEqual(summary["hard_negative_points"], 1)
        self.assertAlmostEqual(
            summary["minimum_traffic_light_distance_m"], math.sqrt(5.0)
        )
        self.assertAlmostEqual(
            summary["minimum_stop_sign_distance_m"], math.sqrt(1.25)
        )

    def test_empty_actor_lists_make_all_route_points_hard_negatives(self):
        summary = score_dense_route(
